...
import { CambiocitaService } from 'src/app/service/citas/cambiocita.service';
...
@Component({
  selector: 'app-cambiocita',
  templateUrl: './cambiocita.component.html',
  styleUrls: ['./cambiocita.component.less']
})
export class CambiocitaComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private cambiocitaService: CambiocitaService,
    private envioCorreoService: EnvioCorreoService,
    public spinnerService: NgxSpinnerService,
    private cookie: CookieService,
    private firestore: AngularFirestore,
    private bloqueoService: BloqueoService,
    public dialogRef: MatDialogRef<CambiocitaComponent>,
